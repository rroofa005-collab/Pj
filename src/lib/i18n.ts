...
export const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    externalMaintenance: "الصيانة الخارجية",
    otherCost: "تكلفة أخرى",
    technicianName: "اسم المصلح",
    phoneStatus: "حالة الهاتف",
    paymentStatus: "حالة الدفع",
    paidAndDelivered: "تم التسليم والدفع",
    totalRepairCost: "اجمالي تكلفة التصليح",
    totalAmountDue: "اجمالي المبلغ المستحق",
    profit: "الفائدة",
    accessControl: "التحكم في الوصول",
    allowedDays: "الأيام المسموح بها",
    allowedTimeStart: "وقت البدء",
    allowedTimeEnd: "وقت الانتهاء",
  ...
  fr: {
    ...
    externalMaintenance: "Maintenance externe",
    otherCost: "Autre coût",
    technicianName: "Nom du technicien",
    phoneStatus: "Statut du téléphone",
    paymentStatus: "Statut du paiement",
    paidAndDelivered: "Payé et livré",
    totalRepairCost: "Coût total réparation",
    totalAmountDue: "Total montant dû",
    profit: "Bénéfice",
    accessControl: "Contrôle d'accès",
    allowedDays: "Jours autorisés",
    allowedTimeStart: "Heure de début",
    allowedTimeEnd: "Heure de fin",
  ...
  en: {
    ...
    allowedTimeStart: "Start Time",
    allowedTimeEnd: "End Time",
